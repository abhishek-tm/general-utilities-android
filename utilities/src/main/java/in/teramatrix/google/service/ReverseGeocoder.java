 ...
 * address, we are interacting to the Google Server (callling Api). Here we are broadcasting results in {@link in.teramatrix.google.service.ReverseGeocoder.ReverseGeocodingListener}
